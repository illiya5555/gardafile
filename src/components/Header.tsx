      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/забронировать"
              className="bg-primary-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-primary-700 transition-all duration-300 hover:scale-105"
            >
              Забронировать
            </Link>
            ...
            <a
              ...
              className="flex items-center space-x-2 px-4 py-2 rounded-lg font-medium border border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white transition-all duration-300 hover:scale-105"
            >
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200">
                <Link
                  to="/забронировать"
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full text-center bg-primary-600 text-white py-3 rounded-lg font-medium hover:bg-primary-700 transition-colors duration-300 mb-4"
                >
                  Забронировать
                </Link>
