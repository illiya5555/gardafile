...
import { Calendar, Users, CreditCard, Shield, Clock, CheckCircle, AlertCircle, Phone, Mail, User } from 'lucide-react';
import { supabase, TimeSlot, Booking } from '../lib/supabase';
...
const BookingPage = () => {
  ...
  const totalPrice = participants * (selectedTimeSlot?.price_per_person || 199);
  ...
  const isStepValid = () => {
    switch (bookingStep) {
      ...
      case 2:
        return formData.customerName && formData.customerEmail && formData.agreeTerms;
      default:
        return true;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {[
              ...
              <div key={item.step} className="flex items-center">
                ...
                <div className="ml-4 hidden sm:block">
                  <p className={`font-semibold transition-colors duration-300 ${bookingStep >= item.step ? 'text-primary-600' : 'text-gray-400'}`}>
                    Step {item.step}
                  </p>
                  <p className={`text-sm transition-colors duration-300 ${bookingStep >= item.step ? 'text-gray-900' : 'text-gray-500'}`}>
                    {item.title}
                  </p>
                </div>
                {index < 2 && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8 animate-fade-in">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-lg transition-all duration-300 hover:border-primary-300"
                    />
                  </div>
                        ...
                        <button
                          ...
                          className={`p-4 rounded-lg border-2 transition-all duration-300 hover:scale-105 ${
                            selectedTime === slot.time
                              ? 'border-primary-600 bg-primary-50 text-primary-600 shadow-lg'
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      <button
                        ...
                        className="w-12 h-12 bg-gray-200 rounded-lg hover:bg-gray-300 transition-all duration-300 flex items-center justify-center text-xl font-semibold hover:scale-110"
                      >
                        -
                      </button>
                      ...
                      <button
                        onClick={() => setParticipants(Math.min(selectedTimeSlot?.max_participants || 8, participants + 1))}
                        className="w-12 h-12 bg-gray-200 rounded-lg hover:bg-gray-300 transition-all duration-300 flex items-center justify-center text-xl font-semibold hover:scale-110"
                      >
                        +
                      </button>
                      <span className="text-gray-600 ml-4">
                        Maximum {selectedTimeSlot?.max_participants || 8} people per boat
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300"
                          required
                        />
                      </div>
                    </div>
              ...
              <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
                ...
                {bookingStep < 3 ? (
                  ...
                  <button
                    ...
                    className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                  >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-32 transition-all duration-300 hover:shadow-xl">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">€{selectedTimeSlot?.price_per_person || 199}</span>
                </div>
              </div>
            ...
            {/* Contact Info */}
            <div className="bg-primary-50 rounded-2xl p-6 mt-6 transition-all duration-300 hover:shadow-md">
