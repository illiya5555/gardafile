...
('home.location.title', 'ru', 'Превосходное расположение в Рива-дель-Гарда', 'home_page'),
...
('home.location.item1.description', 'ru', 'Всего в 4 часах езды от Мюнхена, что делает его идеальным местом для выходных и корпоративных мероприятий.', 'home_page'),
...
('home.location.item2.title', 'ru', 'Условия парусного спорта мирового класса', 'home_page'),
...
('home.location.item2.description', 'ru', 'Озеро Гарда предлагает постоянные ветры и потрясающие альпийские пейзажи, что делает его главным направлением для парусного спорта в Европе.', 'home_page'),
...
('home.partners.subtitle', 'ru', 'Мы работаем с ведущими мировыми производителями яхт и морского оборудования, чтобы предоставить вам наилучшие впечатления от парусного спорта.', 'home_page'),
...
('home.partners.cta', 'ru', 'Свяжитесь с нами по поводу партнерства', 'home_page'),
...
('home.final_cta.subtitle', 'de', 'Begleite uns für einen unvergesslichen Tag bei Yachtrennen am Gardasee. Keine Erfahrung nötig - bring einfach deinen Abenteuergeist mit!', 'home_page'),
...
('home.final_cta.subtitle', 'ru', 'Присоединяйтесь к нам для незабываемого дня яхтенных гонок на озере Гарда. Опыт не нужен - просто принесите свой дух приключений!', 'home_page'),
