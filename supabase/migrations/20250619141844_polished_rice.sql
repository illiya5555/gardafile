/*
  ...
  This migration adds comprehensive translations for the Contact Page in all supported languages.
  
  ## What this migration does:
  1. Adds Contact Page translations for 8 languages (en, de, fr, it, es, pl, he, ru)
  2. Includes translations for:
...
('contact.form.subject.booking', 'acja', 'contact_page'),
