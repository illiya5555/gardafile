              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">{t('gift.features.romantic', 'Romantic getaways')}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Gift className="h-6 w-6 text-green-500" />
                    <span className="text-gray-700">{t('gift.features.birthdays', 'Birthdays & celebrations')}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Users className="h-6 w-6 text-blue-500" />
                    <span className="text-gray-700">{t('gift.features.family', 'Family adventures')}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Star className="h-6 w-6 text-yellow-500" />
                    <span className="text-gray-700">{t('gift.features.special', 'Special achievements')}</span>
                  </div>
                </div>
              </div>
